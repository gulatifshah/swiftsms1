                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete_media.php?id=<?php echo $row['id']; ?>" class="label label-important" onclick="return confirm('Are you PAKKA you want to delete this?')"> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
