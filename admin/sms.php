                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        ...
                                        $viewCategory_id = mysqli_fetch_array($getCategoryById);
                                        echo $viewCategory_id['title']; 
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                ...
                                <td>
                                    ...
                                    <a href="delete_sms.php?id=<?php echo $row['id']; ?>" class="label label-important"  onclick="return confirm('Are you PAKKA you want to delete this?')"> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
